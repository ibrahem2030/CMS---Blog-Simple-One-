				...
				<div class="col-md-8">
					<div class="section-row">
						...
						@foreach($post->tags as $tag)
							<span>Tags : <a href="#" class="badge badge-secondary">{{$tag->tag}}</a></span>
						@endforeach
						<hr>
							...
							<div class="section-row">
								<div class="post-nav">
									...
									<div class="prev-post">
										...
										<h3 class="post-title"><a href="#">{{$prev_post->title}}</a></h3>
									...
									<div class="next-post">
										<a class="post-img" href="{{$next_post->title}}">
											<img src="{{$next_post->file}}" alt=""></a>
										<h3 class="post-title"><a href="#">{{$next_post->title}}</a></h3>
										<span>Next post</span>
									</div>
